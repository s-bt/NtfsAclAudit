...
I wrote this tool as I could not find one that reads ntfs permissions for files and directories and allow to exclude inherited access rules and returns csv/json/... output.
